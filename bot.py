...
# BOT TOKENS
# ============================
BOT_TOKEN = os.getenv("BOT_TOKEN", "8616221600:AAGdERIgS99atUv_rUISXk_n-jM2eS64pJY")
OWNER_BOT_TOKEN = os.getenv("OWNER_BOT_TOKEN", "8919128322:AAESIjOGBP9I5JpAw7kYBWGTQjV8d19CPA-I")
OWNER_CHAT_ID = int(os.getenv("OWNER_CHAT_ID", "100365747986"))
